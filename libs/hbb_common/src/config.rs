...
pub const RENDEZVOUS_SERVERS: &[&str] = &["rs.puxun.co"];
pub const PUBLIC_RS_PUB_KEY: &str = "KX9HToPyLljUzNB20V79Oql8XQFQka+lns688aX+L18=";
...
pub mod keys {
    ...
    pub const OPTION_API_SERVER: &str = "http://rs.puxun.co:21114";
    pub const OPTION_KEY: &str = "KX9HToPyLljUzNB20V79Oql8XQFQka+lns688aX+L18=";
